var messages = (function( ) {
    ...
    messages.prototype.privates = function( uid, connections, date, callback ) {
        ...
        return this.database.connection().collection('Messages').findItems({ $or: [{ ids: { $in: connections } }, { sender: uid }], creationDate: { $lt : date }, public: false },{sort: { creationDate: -1 }, limit: 20 }, callback);
    };
